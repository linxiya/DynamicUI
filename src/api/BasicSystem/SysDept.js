 ...
 * @LastEditTime: 2025-09-29 15:13:59
 * @FilePath: /web3.1/src/api/BasicSystem/SysDept.js
 * @Description: 部门管理
 * 1596307621
...
export function importData() {
  return `ocean-base/sysDept/import`
}

//导出
export function exportData() {
  return `ocean-base/sysDept/export`
}
